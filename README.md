...
* **The Basic**: If you want something small just copy [basic.vim](https://github.com/toszter/vimrc/blob/master/vimrcs/basic.vim) into your ~/.vimrc and you will have a good basic setup
...
The awesome version includes a lot of great plugins, configurations and color schemes that make Vim a lot better. To install it simply do following from your terminal:
	...
	git clone --depth=1 https://github.com/toszter/vimrc.git ~/.vim_runtime
	sh ~/.vim_runtime/install_awesome_vimrc.sh

I also recommend using [the ProfontX font](http://tobiasjung.name/profont/) (it's a free and awesome font designed for source code). The Awesome vimrc is already setup to try to use it.
...
The basic version is useful to install on remote servers where you don't need many plugins, and you don't do many edits.
	...
	git clone --depth=1 git://github.com/toszter/vimrc.git ~/.vim_runtime
...
* [auto-pairs](https://github.com/jiangmiao/auto-pairs): Closes (, ", ', [, {, < and gently inserts newlines and indents so you don't have to. :) NOT ORIGINALLY INCLUDED
